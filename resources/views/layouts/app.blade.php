  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        ...
        <img class="sch_logo" src="/maindir/images/pivo.png">
	      <a class="navbar-brand" href="/">Pivo<span>Apps</span>
          <p class="sch_name">Forseeing the Best</p>
        </a>
      ...
      <div class="row">
        <div class="col-md-7 footer_left">
          <div class="row">
            ...
            <div class="col-md-4 footer_brand">
              <h6>Available</h6>
              <a href="#"><p>Honda</p></a>
              <a href="#"><p>Hyundai</p></a>
              <a href="#"><p>Mitsubishi</p></a>
              <a href="#"><p>Mercedes Benz</p></a>
              <a href="#"><p>Nissan</p></a>
              <a href="#"><p>Mazda</p></a>
            </div>
          </div>
        ...
        <div class="col-md-5 footer_right">
          ...
          {{-- <div class="ftco-footer-widget mb-4"> --}}
            <img src="/maindir/images/pivo.png" style="width: 60px" alt="">
            <h3 class="ftco-heading-2" style="color: #fff">PivoApps</h3>
            <p class="home_copyright">Copyright © {{date('Y')}} PivoApps Inc.</p>
            <p class="home_contact">778-301-5472</p>
          {{-- </div> --}}
